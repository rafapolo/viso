...
// Mock QueryUtils - test its interface, not its implementation
jest.mock('../../src/utils/query-utils.js', () => ({
  QueryUtils: {
...
const { QueryUtils } = require('../../src/utils/query-utils.js');
...
describe('Query Utils and Builder', () => {
  ...
  describe('QueryBuilder', () => {
    let queryBuilder: InstanceType<typeof QueryBuilder>;
